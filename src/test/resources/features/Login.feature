...
Feature: Login Functionality
  ...
  @negative_scenario
  Scenario: When user tries to log in with blank username or password error message needs to be displayed
    Given user is on login page
  ...
  @negative_scenario
  Scenario: When user tries to log in with invalid credentials error message needs to be displayed
    Given user is on login page
